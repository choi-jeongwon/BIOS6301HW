...
**44.5/45, great work! See minor comments**
...
# TS: The vector d missed a few words. # [k].+[[:alpha:]] return words such that k + something + [a-z]. Words such as "like", where there is no letter after "e" would not be returned. -0.5
