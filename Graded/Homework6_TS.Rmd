...
**38/40, good job! See my comments. Tianyi**
...
# TS: The question asked to show the year of init.date.-0.5
...
**TS: Try to avoid for loop when create a variable, this could take some time when you have a large sample size**
```{r}
# Alternative coding
...
# The output from quantile(haart$followup) is not exact. -0.5
...
```{r}
# TS: The question asked to perform all the data cleaning listed above for merged_data. It would be straightforward if we wrap up all above steps into a function. -1
