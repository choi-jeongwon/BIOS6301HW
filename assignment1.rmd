...
The estimate for the intercept is 3.5, and the estimate for the gender is 4.3
...
```{r}
x_pt <- pt(mod.c[2,3], df = 7, lower.tail=FALSE)
2*x_pt
...
sets. (3 points)
variance for los for the men = 5.2, 
variance for los for the women = 4.333333
...
The results from Two Sample t-test correspond to the p-value (t = -2.9171, df = 7, p-value = 0.02243) for gender from the model summary.
